create table if not exists augumentation_learning_chart_tree(
augumentation_learning_id Integer not null,
...
constraint augumentation_learning_chart_tree_pk primary key(augumentation_learning_id));